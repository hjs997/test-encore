#!/bin/bash
export UUID=${UUID:-'53047485-90ce-4b7c-8df2-5f94a18d9868'}
export NEZHA_SERVER=${NEZHA_SERVER:-'sui.txxk.xyz'}
export NEZHA_PORT=${NEZHA_PORT:-'443'}   # 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
export NEZHA_KEY=${NEZHA_KEY:-'0uSEy2FOtr1B4FDGz3'}        # 哪吒三个变量不全不运行
export ARGO_DOMAIN=${ARGO_DOMAIN:-'der.dxxzz.cloudns.ch'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNTQzZDRkZTQzYjBkMjFhY2I0OTgyMmJkZGI1NzdkOTQiLCJ0IjoiNzNiYTM3MDctNzVmZC00OTlkLTgxYWMtMTAwMThlYjIyZWY5IiwicyI6IlpqTXhZamxrWm1FdE1tWmpZaTAwTmpjMkxUZ3lOemN0WlRneFpEazFNbVF5T1RJMCJ9'}
export NAME=${NAME:-'En'}
export CFIP=${CFIP:-'government.se'}
export FILE_PATH=${FILE_PATH:-'./temp'}
export ARGO_PORT=${ARGO_PORT:-'8002'}  # argo隧道端口，若使用固定隧道token请改回8080或CF后台改为与这里对应
